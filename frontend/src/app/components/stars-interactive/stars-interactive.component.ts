...
@Component({
  selector: 'app-stars-interactive',
  templateUrl: './stars-interactive.component.html',
  styleUrls: ['./stars-interactive.component.scss']
})
export class StarsInteractiveComponent implements OnInit {
